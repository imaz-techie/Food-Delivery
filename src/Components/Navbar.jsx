    ...
    <div className="w-full bg-white px-4 py-3 mb-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div className="flex w-full sm:w-auto items-center gap-3">
          {/* Search bar */}
          <form className="flex items-center relative rounded-xl bg-slate-100 flex-1 sm:flex-none sm:w-80">
          ...
          <div className="bg-slate-100 px-4 py-3 rounded relative flex items-center">
            ...
            <MdShoppingCart className="w-6 h-6 sm:w-8 sm:h-8 text-green-800" />
          </div>
        </div>
      </div>
    </div>
