...
const Category = () => {
  const renderCategory = categories.map((category) => {
    return (
      <div className="bg-white p-4 rounded-lg gap-2 w-[140px] h-[80px] flex flex-col items-center justify-center bg-gradient-to-b from-green-400 to-green-700 cursor-pointer hover:bg-green-800 transition-all duration-200 hover:text-white">
